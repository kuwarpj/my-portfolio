...
import { portfolioData, ProjectItem as ProjectItemType } from '@/config/site';
        ...
        <div className="aspect-video overflow-hidden relative">
          ...
          />
           <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
            <Button variant="outline" onClick={() => onOpenDialog(project)} className="text-white border-white hover:bg-white hover:text-gray-900">
              ...
              {selectedProject.detailedDescription && selectedProject.detailedDescription.length > 0 && (
                <div>
                  ...
                  <div className="space-y-2 text-foreground">
                    {selectedProject.detailedDescription.map((detail, i) => (
