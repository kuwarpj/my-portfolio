...
import { Github, Linkedin, Mail, Briefcase, Lightbulb, BarChart3, GraduationCap, UserCircle, Settings, Code, Database, Server, MonitorPlay, Puzzle, Terminal, GitBranch } from 'lucide-react';
...
export const portfolioData: PortfolioData = {
  hero: {
    ...
    subtitle: 'Crafting seamless digital experiences from concept to deployment. Let\'s build something amazing together.',
    cta: {
      label: 'View My Work',
      href: '#projects',
    },
  ...
  projects: [
    {
      ...
      description: 'A full-stack bill-splitting web application allowing user registration, authentication, group management, and real-time expense tracking.',
      technologies: ['Next.js', 'Express.js', 'JWT', 'RESTful APIs'],
      imageUrl: '/projects/sharebill-login.png',
    ...
    },
    {
      ...
      description: 'A minimalist social media app inspired by Twitter, featuring core functionalities like posting, following, and user authentication.',
  ...
  socialLinks: [
    ...
    { name: 'LinkedIn', icon: Linkedin, url: 'https://www.linkedin.com/in/kuwarparasarjha/' },
